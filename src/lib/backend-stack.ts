...
export class BackendStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: StackProps = {}) {
    ...
    const unAuthPrincipal = new WebIdentityPrincipal(
    ...
    const unauthRole = new Role(this, "identity-unauth-role", {
    ...
    this.appsyncTransformer = new AppSyncTransformer(this, "appsync", {
